...
export default function NPCDetect() {
  ...
  async function callAPI(msgs: Message[]) {
    ...
    try {
      ...
      throw new Error(`Server returned non-JSON (HTTP ${res.status}): ${text.slice(0, 400)}`);
    }
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.footerBar}>
        <span>NPCDetect™ is a <a href="https://monochromacy.com">Monochromacy</a> product</span>
